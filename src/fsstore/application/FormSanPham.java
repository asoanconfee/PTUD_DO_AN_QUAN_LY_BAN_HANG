...
public class FormSanPham extends javax.swing.JPanel {
    ...
    public FormSanPham() {
        initComponents();
        jTextField11.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Nhập mã hoặc tên sản phẩm để tìm");
    }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Chọn file ảnh");
        ...
        jLabel6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 4));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Áo", "Quần", "Váy", "Áo khoát", "Giày", "Dép", "Phụ kiện" }));
        ...
        jLabel17.setText("Mã NCC");

        jLabel3.setText("Mã sản phẩm");

        jLabel18.setText("Tên NCC");
        ...
        jTextField11.setText("Nhập mã hoặc tên sản phẩm để tìm");

        jLabel19.setText("Tìm kiếm");

        jButton5.setBackground(new java.awt.Color(0, 158, 15));
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Hình ảnh", "Mã sản phẩm", "Tên sản phẩm", "Ngày nhập", "Kích cỡ", "Màu sắc", "Số lượng", "Xuất xứ", "Thương hiệu", "Chất liệu", "Giá bán"
            }
        ) {
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Áo", "Quần", "Váy", "Áo khoát", "Giày", "Dép", "Phụ kiện" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã sản phẩm", "Tên sản phẩm", "Kích cỡ", "Màu sắc", "Gía bán", "Số lượng"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã sản phẩm", "Tên sản phẩm", "Ngày bắt đầu", "Số lượng", "Giá lúc đầu", "Giá lúc sau", "% Khuyến mãi"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Thông tin khuyến mãi"));
        ...
        jLabel22.setText("Kích cỡ");

        jComboBox8.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "XS", "S", "M", "L", "XL", "XXL" }));
        jComboBox8.setEnabled(false);

        jLabel23.setText("Màu sắc");

        jComboBox9.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Đen", "Trắng", "Xám", "Kem", "Đỏ", "Xanh lá", "Xanh dương", "Hồng", "Khác" }));
        jComboBox9.setEnabled(false);

        jLabel24.setText("Kiểu dáng");

        jComboBox10.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BodyCom", "A - line", "Trench - coat", "Khác" }));
        ...
        jComboBox11.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vải cotton", "Vải len", "Nỉ da cá", "Khác" }));
        ...
        jLabel27.setText("% Khuyễn mãi");

        jComboBox12.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "10%", "20%", "25%", "50%", "70%", "80%", "90%" }));
        ...
        jButton2.setBackground(new java.awt.Color(0, 158, 15));
        jButton2.setText("Thêm khuyến mãi");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                i = ImageIO.read(f);
                jLabel6.setIcon(new ImageIcon(i));
            } catch (Exception e) {
            }
        }
