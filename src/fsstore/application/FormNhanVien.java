...
public class FormNhanVien extends javax.swing.JPanel {
    ...
    public FormNhanVien() {
        initComponents();
        jTextField1.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Nhập sđt hoặc tên nhân viên để tìm");
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(0, 158, 15));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nhân viên bán hàng", "Quản lý", "Thu ngân" }));

        jLabel10.setText("Trạng thái");

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Còn hoạt động", "Ngưng hoạt động" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Hình ảnh", "Mã nhân viên", "Tên nhân viên", "Chức vụ"
            }
        ) {
