...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Sáng", new FlatSVGIcon("fsstore/menu/mode/light.svg"));
        buttonDark = new JButton("Tối", new FlatSVGIcon("fsstore/menu/mode/dark.svg"));
