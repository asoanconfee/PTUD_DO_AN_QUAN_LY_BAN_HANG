package fsstore.menu;

import fsstore.menu.mode.LightDarkMode;
...
import fsstore.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String headerName = "Fashion";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/fsstore/icon/png/logomain.png")));
